...
elif options.parser == 'tt100k':
    from keras_frcnn.TT100K_parser import get_data
else:
    raise ValueError("Command line option parser must be one of 'pascal_voc', 'simple' or 'tt100k'")
